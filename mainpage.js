...
function showSelectedOperator(){
    ...
    for (var i=0; i<elements.length; i++){
        elements[i].style.backgroundColor  = "#049c67";
    }

    if (operator_value == "+"){
        document.getElementById("plusOp").style.backgroundColor  = "#1affaf";
    }
    else if (operator_value == "-"){
        document.getElementById("subOp").style.backgroundColor  = "#1affaf";
    }
    else if (operator_value == "*"){
        document.getElementById("multiOp").style.backgroundColor  = "#1affaf";
    }
    else if (operator_value == "/"){
        document.getElementById("divOp").style.backgroundColor  = "#1affaf";
    }
}
